...
wget http://apt.puppetlabs.com/puppetlabs-release-pc1-precise.deb
...
apt-get update
apt-get -y upgrade
apt-get install -y git vim wget rsync screen dnsutils netcat telnet puppet-agent elinks lynx bzip2 unzip tcpdump man-db mlocate ccze htop traceroute nfs-common
